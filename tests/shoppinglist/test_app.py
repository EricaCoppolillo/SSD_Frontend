...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'description': '',
        'quantity': 2})])
@patch('builtins.input',side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Redmi Note 8', 'Xiaomi', '2', '900', '','0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 2})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', '<script>', 'Mi 8 pro', 'Xiaomi', '2', '900', '','0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 2})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Pocophone', 'Poco', 'asd', '-1', '2', '900', '','0','0'])
@patch('builtins.print')
def test_app_add_smartphone_resists_wrong_quantity(mocked_print, mocked_input, mocked_requests_get, mocked_requests_post):
    with patch('builtins.open', mock_open()) as mocked_open:
        App().run()
    assert list(filter(lambda x: 'Smartphone added!' in str(x), mocked_print.mock_calls))
    mocked_requests_post.assert_called_with(url='http://localhost:8000/api/v1/shopping-list/add/', headers={
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 2})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Xperia z1', 'Sony', '2', 'asd', '-1', '900', '','0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 2})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Xperia z1', 'Sony', '2', '900', '', '3','1', '0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 5})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '2', '<script>', 'Magicbook', 'Huawei', '5', '650.30', '','0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 2})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '2', 'Msv330', 'Msi', 'asd', '-1', '2', '900', '','0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 2})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '2', 'Sxs500v', 'Asus', '2', 'asd', '-1', '900', '','0','0'])
@patch('builtins.print')
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'description': '',
        'quantity': 2})])
@patch('builtins.input', side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1','Xperia z1','Sony','2','900','', '3', '4', '1','0','0'])
@patch('builtins.print')
def test_app_remove_item_resists_wrong_index(mocked_print, mocked_input, mocked_requests_get, mocked_requests_post,mocked_requests_delete):
    with patch('builtins.open', mock_open()) as mocked_open:
        App().run()
    mocked_input.assert_called()
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'quantity': 1})])
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Pixel', 'Google', '1', '973.20', '', '4', '1','5','0','0'])
@patch('builtins.print')
def test_app_change_quantity(mocked_print, mocked_input,  mocked_requests_get, mocked_requests_post,mocked_requests_patch):
    with patch('builtins.open', mock_open()) as mocked_open:
        App().run()
    mocked_input.assert_called()
    mocked_print.assert_called()
...
@patch('requests.get', side_effect=[mock_response_dict(200,{'id': 1,
        ...
        'description': '',
        'quantity': 1})])
@patch('builtins.input', side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Pixel', 'Google', '1', '973.20', '', '4', '-1', '1', '5','0','0'])
@patch('builtins.print')
def test_app_change_quantity_resists_wrong_index(mocked_print, mocked_input,  mocked_requests_get, mocked_requests_post,mocked_requests_patch):
    with patch('builtins.open', mock_open()) as mocked_open:
        App().run()
    mocked_input.assert_called()
    mocked_print.assert_called()
...
@patch('builtins.input', side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '1', 'Pixel', 'Google', '1', '973.20', '', '4', '1', '-1', '5', '0', '0'])
@patch('builtins.print')
def test_app_change_quantity_resists_wrong_new_quantity(mocked_print, mocked_input,  mocked_requests_get, mocked_requests_post,mocked_requests_patch):
    with patch('builtins.open', mock_open()) as mocked_open:
        App().run()
    mocked_input.assert_called()
    mocked_print.assert_called()
...
@patch('builtins.input', side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '2','Mi Air','Xiaomi','1','400','','2', 'Mac', 'Apple', '1', '1', '', '6','0','0'])
@patch('builtins.print')
...
@patch('builtins.input',
       side_effect=['1', 'ciccioRiccio99', 'ciccioRiccio9!', '2','Mi Air','Xiaomi','1','400','','2', 'Mac', 'Apple', '1', '1', '','5','0','0'])
@patch('builtins.print')
